 ...
 */
  ...
  * 
  * This exception is thrown by CpuTaskExecutor when a CPU-intensive task
  ...
  * delivered through the Promise mechanism to maintain thread safety
  ...
  * 
  * @see CpuTaskExecutor::executeAsync, Promise::catch_error
  */
  ...
  * 
  * @see Promise, SLLooper, CpuTaskTimeoutException
  */
 class CpuTaskExecutor {
 public:
     /**
